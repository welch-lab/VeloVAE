...
import anndata
import time
retina_adata_raw = anndata.read_h5ad('/data/scRNA/retina.h5ad')

retina_adata_processed = preprocess_dataset(data_set_name = 'retina',
                                            adata = retina_adata_raw,
                                            data_processed_path = '/data/external',
                                            n_top_genes = 2000)

#model1
start=time.time()
result = train_dataset(retina_adata_processed,
                       data_set_name = 'retina',
                       offset=False,
