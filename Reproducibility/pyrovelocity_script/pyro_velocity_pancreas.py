...
pancreas_adata_raw = anndata.read_h5ad('/data/scRNA/pancreas.h5ad')

pancreas_adata_processed = preprocess_dataset(data_set_name = 'pancreas',
                                              adata = pancreas_adata_raw,
                                              data_processed_path = '/data/external',
                                              n_top_genes = 2000)

#model1
start=time.time()
result = train_dataset(pancreas_adata_processed,
