...
organoids_adata_raw = anndata.read_h5ad('/data/scRNA/organoids.h5ad')

organoids_adata_processed = preprocess_dataset(data_set_name = 'IO_EU',
                                              adata = organoids_adata_raw,
                                              data_processed_path = '/data/external',
                                              n_top_genes = 1000)

#model1
start=time.time()
result = train_dataset(organoids_adata_processed,
                       data_set_name = 'IO_EU',
                       offset=False,
