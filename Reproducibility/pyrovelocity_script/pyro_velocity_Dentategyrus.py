...
dentategyrus_adata_raw = anndata.read_h5ad('/data/scRNA/Dentategyrus/Dentategyrus.h5ad')

dentategyrus_adata_processed = preprocess_dataset(data_set_name = 'Dentategyrus',
                                              adata = dentategyrus_adata_raw,
                                              data_processed_path = '/data/external',
                                              n_top_genes = 1000)
#model1
start=time.time()
result = train_dataset(dentategyrus_adata_processed,
                       data_set_name = 'Dentategyrus',
                       offset=False,
