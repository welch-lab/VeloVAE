...
scifate2_adata_raw = anndata.read_h5ad('/data/scRNA/scifate2.h5ad')

scifate2_adata_processed = preprocess_dataset(data_set_name = 'scifate2',
                                            adata = scifate2_adata_raw,
                                            data_processed_path = '/data/external',
                                            n_top_genes = 2000)

#model1
start=time.time()
result = train_dataset(scifate2_adata_processed,
                       data_set_name = 'scifate2',
                       offset=False,
