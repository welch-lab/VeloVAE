...
neuron_splicing_lite_adata_raw = anndata.read_h5ad('/data/scRNA/neuron_splicing_lite.h5ad')

neuron_splicing_lite_adata_processed = preprocess_dataset(data_set_name = 'scNT-Neuron',
                                              adata = neuron_splicing_lite_adata_raw,
                                              data_processed_path = '/data/external',
                                              n_top_genes = 1000)

#model1
start=time.time()
result = train_dataset(neuron_splicing_lite_adata_processed,
                       data_set_name = 'scNT-Neuron',
                       offset=False,
