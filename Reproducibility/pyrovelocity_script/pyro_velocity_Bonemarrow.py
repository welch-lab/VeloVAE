...
Bonemarrow_adata_raw = anndata.read_h5ad('/data/scRNA/Bonemarrow/Bonemarrow.h5ad')

Bonemarrow_adata_processed = preprocess_dataset(data_set_name = 'Bonemarrow',
                                              adata = Bonemarrow_adata_raw,
                                              data_processed_path = '/data/external',
                                              n_top_genes = 2000)

#model1
start=time.time()
result = train_dataset(Bonemarrow_adata_processed,
