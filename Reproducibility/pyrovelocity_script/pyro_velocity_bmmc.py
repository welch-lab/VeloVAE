...
bmmc_adata_raw = anndata.read_h5ad('/data/scRNA/BMMC/BMMC.h5ad')

bmmc_adata_processed = preprocess_dataset(data_set_name = 'BMMC',
                                          adata = bmmc_adata_raw,
                                          data_processed_path = '/data/external',
                                          n_top_genes = 2000)

#model1
start=time.time()
result = train_dataset(bmmc_adata_processed,
                       data_set_name = 'BMMC',
                       offset=False,
