...
start = time.time()
VELOVI.setup_anndata(TLS, spliced_layer="Ms", unspliced_layer="Mu")
torch.set_float32_matmul_precision('highest')
vae = VELOVI(TLS)
scvi.settings.seed=2022
vae.train(max_epochs=500, accelerator = "cuda", devices=1, train_size=0.7)
...
add_velovi_outputs_to_adata(TLS, vae)
TLS.write_h5ad('/VeloVAE/velovi/output/TLS_velovi.h5ad')
# In[36]:
